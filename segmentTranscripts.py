...
if __name__=='__main__':
	...
	parser.add_argument('-i', '--infile', type=str, required=True, help='Pandas-format CSV containing the sequence information')
	...
	parser.add_argument('-p', '--prefix', type=str, help='output filename prefix', default=None)
	parser.add_argument('-s', '--sort', type=str, help="name of the column to sort the values by. Default is ``rank''", default='rank')
	args = parser.parse_args()
	f = segmentTranscripts(args.infile, transcript_column=args.column, sort_by=args.sort, out_prefix=args.prefix)
	print "Finished"
